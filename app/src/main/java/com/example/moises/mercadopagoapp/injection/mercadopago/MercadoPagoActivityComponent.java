...
import com.example.moises.mercadopagoapp.injection.mercadopago.installments.InstallmentsFragmentModule;
...
@Subcomponent(modules = {MercadoPagoActivityModule.class, EnterAmountFragmentModule.class,
        PaymentMethodsFragmentModule.class, CardIssuersFragmentModule.class, InstallmentsFragmentModule.class})
